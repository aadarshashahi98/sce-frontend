        ...
        {isHome && (
          <div>
            <button
              ...
              className="px-5 py-2.5 bg-[#FE9921] border-2 border-[#FE9921] hover:bg-transparent hover:text-[#FE9921] hover:border-white rounded-2xl cursor-pointer transition-colors duration-200 group"
            >
